...
/*\
title: $:/plugins/bangyou/tw-literature/route/literature/article.js
...
(function () {
	...
	"use strict";
	if ($tw.node) {
		var utils = require("$:/plugins/bangyou/tw-literature/utils/utils.js");
	}
	...
	exports.handler = function (request, response, state) {
		...
		var pathLiterature = ($tw.wiki.getTiddler("$:/config/tw-literature/path/literature/html") || {}).fields?.text || "literature";
		...
		fs.readFile(fullPathLiteratureHtml, "utf8", (err, html) => {
			...
			const siteConfigTiddler = $tw.wiki.getTiddler("$:/plugins/bangyou/tw-literature/config/article", "");
			...
			// const scriptText = $tw.wiki.getTiddler("$:/plugins/bangyou/tw-literature/script/highlight.js", "");
			...
			// const styleTiddler = $tw.wiki.getTiddler("$:/plugins/bangyou/tw-literature/style/style.js");
			// if (!styleTiddler) {
			// 	response.writeHead(500, { "Content-Type": "text/plain" });
