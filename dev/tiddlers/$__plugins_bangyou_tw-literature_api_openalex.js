/*\
title: $:/plugins/bangyou/tw-literature/utils/openalex.js
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper('openalex', 9999999);
    ...
    function OpenAlex(host = "https://api.openalex.org/") {
        ...
        function isEnabled() {
            let tiddler = $tw.wiki.getTiddler("$:/config/tw-literature/authoring/openalex/enable");
            if (!tiddler) {
        ...
        function getOpenAlexDailyLimit() {
            if (typeof $tw !== "undefined" && $tw.wiki) {
                const limitText = $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/openalex/daily-limit", "").trim();
