/*\
title: $:/plugins/bangyou/tw-connector/api/crossref.js
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-connector/api/cachehelper.js').cacheHelper('crossref', 9999999);
