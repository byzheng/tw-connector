/*\
title: $:/plugins/bangyou/tw-literature/utils/wos.js
...
\*/
/*\
title: $:/plugins/bangyou/tw-literature/utils/orcid.js
type: application/javascript
module-type: library
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper("orcid", 9999999);
    function ORCID(host = "https://pub.orcid.org") {
        const this_host = host.replace(/\/+$/, "");
        const path_works = "/v3.0";

        function isEnabled() {
            let tiddler = $tw.wiki.getTiddler("$:/config/tw-literature/authoring/orcid/enable");
            if (!tiddler) {
        ...
        function getORCIDDailyLimit() {
            if (typeof $tw !== "undefined" && $tw.wiki) {
                const limitText = $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/orcid/daily-limit", "").trim();
