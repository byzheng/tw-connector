/*\
title: $:/plugins/bangyou/tw-literature/api/reading.js
 ...
 *
 * @module $:/plugins/bangyou/tw-literature/api/reading.js
 * @type {application/javascript}
 * @library
 *
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper('reading', 9999999);
