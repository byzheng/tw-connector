/*\
title: $:/plugins/bangyou/tw-literature/utils/cachehelper.js
...
(function (exports) {
    ...
    function cacheHelper(cacheName, limit = MAX_CACHE_ITEMS) {
        ...
        function getExpredDays() {
            const userExpiredDays = $tw.wiki.getTiddlerText('$:/config/tw-literature/authoring/expired-days', '30');
        ...
        function getDeleteMaximum() {
            const userDeleteMaximum = $tw.wiki.getTiddlerText('$:/config/tw-literature/authoring/delete-maximum', '10');
