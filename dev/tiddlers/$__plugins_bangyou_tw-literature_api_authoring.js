/*\
title: $:/plugins/bangyou/tw-literature/api/authoring.js
 ...
 *
 * @module $:/plugins/bangyou/tw-literature/api/authoring.js
 * @type {application/javascript}
 * @library
 *
 ...
 *
 * @example
 * const authoring = require('$:/plugins/bangyou/tw-literature/api/authoring.js').Authoring();
...
(function (exports) {
    ...
    var helper = require('$:/plugins/bangyou/tw-literature/utils/helper.js').Helper();
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper('authoring', 9999999);
    ...
    var platforms = [
        ...
        require('$:/plugins/bangyou/tw-literature/api/openalex.js').OpenAlex()
    ];
    function Authoring() {
