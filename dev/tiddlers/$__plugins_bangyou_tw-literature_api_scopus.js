/*\
title: $:/plugins/bangyou/tw-literature/utils/scopus.js
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper("scopus", 9999999);
    ...
    function SCOPUS(host = "https://api.elsevier.com") {
        ...
        function getScopusDailyLimit() {
            if (typeof $tw !== "undefined" && $tw.wiki) {
                const limitText = $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/scopus/daily-limit", "").trim();
        ...
        function getScopusApiKey() {
            if (typeof $tw !== "undefined" && $tw.wiki) {
                return $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/scopus/api", "").trim();
            }
            return "";
        }
        ...
        async function scopusRequest(url) {
            ...
            if (!apiKey || apiKey === "") {
                console.error("Scopus API key is not configured. Please set it in $:/config/tw-literature/authoring/scopus/api tiddler.");
                return;
            }
            const headers = {
                "X-ELS-APIKey": apiKey,
