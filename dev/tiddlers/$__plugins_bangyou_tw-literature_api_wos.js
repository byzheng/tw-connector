...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-literature/api/cachehelper.js').cacheHelper("wos", 9999999);
    ...
    function WOS(host = "https://api.clarivate.com") {
        ...
        function getWOSDailyLimit() {
            ...
            if (typeof $tw !== "undefined" && $tw.wiki) {
                const limitText = $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/wos/daily-limit", "").trim();
        ...
        function getWOSApiKey() {
            // In TiddlyWiki, global $tw object provides access to tiddlers
            if (typeof $tw !== "undefined" && $tw.wiki) {
                return $tw.wiki.getTiddlerText("$:/config/tw-literature/authoring/wos/api", "").trim();
            }
            return "";
        }
