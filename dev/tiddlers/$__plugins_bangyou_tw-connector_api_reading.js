/*\
title: $:/plugins/bangyou/tw-connector/api/reading.js
 ...
 *
 * @module $:/plugins/bangyou/tw-connector/api/reading.js
 * @type {application/javascript}
 * @library
 *
...
(function (exports) {
    ...
    const cacheHelper = require('$:/plugins/bangyou/tw-connector/api/cachehelper.js').cacheHelper('reading', 9999999);
